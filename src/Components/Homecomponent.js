...
class Home extends Component {
    ...
    render() {
        return (
            <div className="home body" style={{ backgroundColor: "rgba(192,192,192)" }}>
            <div className="container" style={{ backgroundColor: "rgba(192,192,192)" }}>
                <div class="bg-image"
                    ...
                    <a class="btn " style={{ fontWeight: '100', backgroundColor: 'rgba(147,58,22)', color: 'floralwhite' }}
                        href="./Shop.html" role="button">Shop Now</a>

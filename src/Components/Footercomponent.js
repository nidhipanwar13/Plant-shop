    ...
    render() {
        return (
            <div className="footer" style={{ backgroundColor: "rgba(192,192,192)" }}>
                  <div className="container" style={{ backgroundColor: 'rgba(0,41,41)', color: 'white'}}><br /><br /><br /><br />
        <div className="row">
            ...
            <div className=" col-12 col-md-3 text-center">
                <h5 >HELP</h5>
                <a  href="./Shipping.html"  style={{color: 'white'}}><u>Shipping & Returns </u></a><br/>
                <a href="./privacy.html"  style={{color: 'white'}}><u>Privacy Policy</u></a><br/>
                <a href="./FAQ.html" style={{color: 'white'}}><u>FAQ </u></a>
            </div>
        </div><br/><br/>
